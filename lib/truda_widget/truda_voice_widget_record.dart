...
class TrudaVoiceWidgetRecord extends StatefulWidget {
  ...
  @override
  _TrudaVoiceWidgetRecordState createState() => _TrudaVoiceWidgetRecordState();
}

class _TrudaVoiceWidgetRecordState extends State<TrudaVoiceWidgetRecord> {
  // 倒计时总时长
  int _countTotal = 60;
