...
class TrudaSheetHostOption extends StatefulWidget {
  ...
  TrudaSheetHostOption({Key? key, required this.herId}) : super(key: key);

  @override
  State<TrudaSheetHostOption> createState() => _TrudaSheetHostOptionState();
}

class _TrudaSheetHostOptionState extends State<TrudaSheetHostOption> {
  @override
  void initState() {
    super.initState();
  }
