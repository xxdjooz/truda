...
class NewHitaHostPage extends StatefulWidget {
  NewHitaHostPage({Key? key}) : super(key: key);

  @override
  State<NewHitaHostPage> createState() => _NewHitaHostPageState();
}

class _NewHitaHostPageState extends State<NewHitaHostPage>
  ...
  @override
  void didUpdateWidget(covariant NewHitaHostPage oldWidget) {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaHostController>(builder: (_controller) {
  ...
  Widget _wBottomButton(NewHitaHostController _controller) {
  ...
  Widget _detailInfo(NewHitaHostController _controller) {
    return Stack(
      fit: StackFit.expand,
  ...
  Widget _mediaList(NewHitaHostController _controller) {
    return Builder(builder: (context) {
  ...
  Widget _momentList(NewHitaHostController _controller) {
