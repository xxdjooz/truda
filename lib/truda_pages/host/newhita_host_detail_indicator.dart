...
class NewHitaHostDetailIndicator extends Decoration {
  @override
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _NewHitaHomeIndicatorPainter(this, onChanged);
  }
}

class _NewHitaHomeIndicatorPainter extends BoxPainter {
  final NewHitaHostDetailIndicator binIndicator;

  _NewHitaHomeIndicatorPainter(this.binIndicator, VoidCallback? onChanged);
