...
class NewHitaHostContributeController extends GetxController
...
class NewHitaHostContributeView
    extends GetView<NewHitaHostContributeController> {
  String herId;

  NewHitaHostContributeView({Key? key, required this.herId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    Get.put(NewHitaHostContributeController()..herId = herId);
    return Container(
