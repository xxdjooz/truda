...
class NewHitaInviteBonusPage extends GetView<NewHitaInviteBonusController> {
  NewHitaInviteBonusPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaInviteBonusController>(builder: (contro) {
      return Scaffold(
        ...
        body: GetBuilder<NewHitaInviteBonusController>(builder: (controller) {
