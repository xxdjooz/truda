...
class NewHitaInvitePage extends GetView<NewHitaInviteController> {
  NewHitaInvitePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final screenWidth = Get.width;
    return GetBuilder<NewHitaInviteController>(builder: (contr) {
      return Scaffold(
