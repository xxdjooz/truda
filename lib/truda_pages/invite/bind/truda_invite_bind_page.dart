...
class TrudaInviteBindPage extends GetView<TrudaInviteBindController> {
  TrudaInviteBindPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TrudaInviteBindController>(
      builder: (contr) {
        return Container(
