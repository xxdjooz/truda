...
import 'package:truda/truda_pages/login/account/newhita_account_register_page.dart';
...
class NewHitaAccountLoginPage extends StatefulWidget {
  const NewHitaAccountLoginPage({Key? key}) : super(key: key);

  @override
  _NewHitaAccountLoginPageState createState() =>
      _NewHitaAccountLoginPageState();
}

class _NewHitaAccountLoginPageState extends State<NewHitaAccountLoginPage>
    with RouteAware {
