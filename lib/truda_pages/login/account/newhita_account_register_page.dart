...
import '../newhita_login_to_main_api.dart';

class NewHitaAccountRegisterPage extends StatefulWidget {
  const NewHitaAccountRegisterPage({Key? key}) : super(key: key);

  @override
  _NewHitaAccountRegisterPageState createState() =>
      _NewHitaAccountRegisterPageState();
}

class _NewHitaAccountRegisterPageState extends State<NewHitaAccountRegisterPage>
    with RouteAware {
  ...
  void accountRegister() {
    ...
    if (_textEditingController2.text.length <= 5) {
      NewHitaLoading.toast(TrudaLanguageKey.newhita_invalid_password.tr);
      return;
    }
