...
// 修改密码
class NewHitaAccountPasswordPage extends StatefulWidget {
  const NewHitaAccountPasswordPage({Key? key}) : super(key: key);

  @override
  _NewHitaAccountPasswordPageState createState() =>
      _NewHitaAccountPasswordPageState();
}

class _NewHitaAccountPasswordPageState
    extends State<NewHitaAccountPasswordPage> with RouteAware {
