...
class NewHitaInfoPage extends GetView<NewHitaInfoController> {
  NewHitaInfoPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaInfoController>(
      dispose: (c) {
  ...
  void _editName(NewHitaInfoController controller) {
  ...
  void _editIntro(NewHitaInfoController controller, BuildContext context) {
