...
import 'newhita_cost_list_controller.dart';

class NewHitaCostListPage extends GetView<NewHitaCostListController> {
  NewHitaCostListPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(NewHitaCostListController());
    return GetBuilder<NewHitaCostListController>(builder: (contro) {
      return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: GetBuilder<NewHitaCostListController>(builder: (controller) {
...
class NewHitaCostItem extends StatelessWidget {
  TrudaCostBean costBean;

  NewHitaCostItem(this.costBean);
