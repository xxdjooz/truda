...
import 'newhita_order_list_controller.dart';

class NewHitaOrderListPage extends GetView<NewHitaOrderListController> {
  NewHitaOrderListPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(NewHitaOrderListController());
    return GetBuilder<NewHitaOrderListController>(builder: (contro) {
      return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: GetBuilder<NewHitaOrderListController>(builder: (controller) {
...
class NewHitaOrderItem extends StatelessWidget {
  TrudaOrderData data;

  NewHitaOrderItem(this.data);
