...
class NewHitaOrderDetailPage extends StatefulWidget {
  const NewHitaOrderDetailPage({Key? key}) : super(key: key);

  @override
  _NewHitaOrderDetailPageState createState() => _NewHitaOrderDetailPageState();
}

class _NewHitaOrderDetailPageState extends State<NewHitaOrderDetailPage> {
  @override
