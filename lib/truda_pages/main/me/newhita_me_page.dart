...
class NewHitaMePage extends StatelessWidget {
  NewHitaMePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final NewHitaMeController meController = Get.put(NewHitaMeController());
    return GetBuilder<NewHitaMeController>(
      initState: (c) {
