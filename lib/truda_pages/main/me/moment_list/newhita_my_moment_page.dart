...
class NewHitaMyMomentPage extends GetView<NewHitaMyMomentController> {
  NewHitaMyMomentPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaMyMomentController>(builder: (contro) {
      return Scaffold(
        ...
        body: GetBuilder<NewHitaMyMomentController>(builder: (controller) {
