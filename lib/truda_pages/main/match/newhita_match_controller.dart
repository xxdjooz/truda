...
import 'newhita_match_page.dart';

class NewHitaMatchController extends GetxController with RouteAware {
  // 0匹配中，1匹配到，2匹配失败
  int matching = 2;
  ...
  void _getOneHost({bool showLoading = false}) {
    ...
    if (getTodayTimes() >= NewHitaMatchPage.totalMatchTimes && !isVip) {
  ...
  void refreshTodayTimes() {
    NewHitaMatchPage.todayMatchTimes.value = getTodayTimes();
  }
