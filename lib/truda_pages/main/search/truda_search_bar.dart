...
/// 搜索AppBar
class TrudaAppBarSearch extends StatefulWidget implements PreferredSizeWidget {
  TrudaAppBarSearch({
    Key? key,
  ...
  @override
  _TrudaAppBarSearchState createState() => _TrudaAppBarSearchState();

  @override
  Size get preferredSize => Size.fromHeight(height);
}

class _TrudaAppBarSearchState extends State<TrudaAppBarSearch> {
