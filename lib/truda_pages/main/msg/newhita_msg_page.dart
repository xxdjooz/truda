...
import 'newhita_msg_controller.dart';

class NewHitaMsgPage extends StatelessWidget {
  NewHitaMsgPage({Key? key}) : super(key: key);
  final NewHitaMsgController msgController = Get.put(NewHitaMsgController());

  @override
  Widget build(BuildContext context) {
    NewHitaLog.debug("NewHitaMsgPage build");
    return GetBuilder<NewHitaMsgController>(builder: (controller) {
      return Scaffold(
...
class NewHitaMsgWidget extends StatelessWidget {
  ...
  final NewHitaMsgController msgController;
