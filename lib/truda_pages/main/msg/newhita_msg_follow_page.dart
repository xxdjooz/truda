...
class NewHitaMsgFollowPage extends StatelessWidget {
  NewHitaMsgFollowPage({Key? key}) : super(key: key);
  final NewHitaMsgFollowController msgController =
      Get.put(NewHitaMsgFollowController());
        ...
        return msgController.dataList.value.isEmpty
            ...
            : RefreshIndicator(
                ...
                child: ListView.builder(
                    ...
                    itemExtent: 90,
                    itemBuilder: (context, index) {
                      return NewHitaMsgWidget(msg: msgController.dataList[index]);
                    }),
              );
      }),
    );
...
class NewHitaMsgWidget extends StatelessWidget {
  ...
  const NewHitaMsgWidget({Key? key, required this.msg}) : super(key: key);
