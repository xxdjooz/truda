...
class NewHitaCreatePage extends GetView<NewHitaCreateController> {
  NewHitaCreatePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaCreateController>(builder: (contro) {
      return Listener(
        onPointerDown: (event) {
