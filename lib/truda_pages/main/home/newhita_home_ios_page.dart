...
import 'package:truda/truda_pages/main/home/newhita_home_ios_controller.dart';
import 'package:truda/truda_pages/main/home/newhita_home_page.dart';
...
class NewHitaHomeIosPage extends StatefulWidget {
  NewHitaHomeIosPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _NewHitaHomeIosPageState();
}

class _NewHitaHomeIosPageState extends State<NewHitaHomeIosPage>
    with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  late final TabController _tabController;
  final NewHitaHomeIosController _homeController =
      Get.put(NewHitaHomeIosController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [NewHitaMomentListPage(iosMock:true), NewHitaFollowPage()],
      ),
    );
  }
