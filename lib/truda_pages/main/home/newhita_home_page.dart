...
import 'package:truda/truda_pages/main/home/newhita_hot_page.dart';
import 'package:truda/truda_pages/main/home/newhita_online_page.dart';
...
class NewHitaHomePage extends StatefulWidget {
  NewHitaHomePage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _NewHitaHomePageState();
}

class _NewHitaHomePageState extends State<NewHitaHomePage>
    with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  late final TabController _tabController;
  final NewHitaHomeController _homeController =
      Get.put(NewHitaHomeController());
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      ...
      NewHitaPageIndexManager.setHomeIndex(_tabController.index);
    });
...
class NewHitaMainFloat extends StatefulWidget {
  NewHitaMainFloat({Key? key}) : super(key: key);

  @override
  State<NewHitaMainFloat> createState() => _NewHitaMainFloatState();
}

class _NewHitaMainFloatState extends State<NewHitaMainFloat> {
  late Offset _offset;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Stack(
        ...
        children: [
          Positioned.fill(child: NewHitaHotPage()),
