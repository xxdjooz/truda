...
class NewHitaHotPage extends StatefulWidget {
  NewHitaHotPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _NewHitaHotPageState();
}

class _NewHitaHotPageState extends State<NewHitaHotPage>
    with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  late TabController _tabController;
  int currentPageIndex = 0;
  List<Widget> countryTabs = [];
  late final NewHitaHotController _controller;

  @override
  void initState() {
    super.initState();
    _controller = Get.put(NewHitaHotController());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetBuilder<NewHitaHotController>(
...
class NewHitaBanner extends GetView<NewHitaHotController> {
  var currentIndex = 0.obs;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NewHitaHotController>(
                ...
                if (bannerBean.target == 0) {
                  ...
                  if (bannerBean.link?.contains("/user?id") == true) {
                    ...
                    if (upid != null) {
                      ...
                      NewHitaHostController.startMe(upid, null);
                    }
