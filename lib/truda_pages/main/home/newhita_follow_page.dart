...
class NewHitaFollowPage extends StatelessWidget {
  NewHitaFollowPage({Key? key}) : super(key: key);
  final NewHitaFollowController _controller =
      Get.put(NewHitaFollowController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetBuilder<NewHitaFollowController>(builder: (controller) {
...
class NewHitaFollowWidget extends StatelessWidget {
  final TrudaHostDetail detail;

  const NewHitaFollowWidget({Key? key, required this.detail}) : super(key: key);
